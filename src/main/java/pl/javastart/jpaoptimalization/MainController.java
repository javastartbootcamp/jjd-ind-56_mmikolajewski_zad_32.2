...
public class MainController {
    ...
    public String countryWithLanguages(Model model) {
        List<Country> countries = countryService.findAllWithLanguage();
    ...
    public String languagesWithCountries(Model model) {
        Map<String, List<String>> languageAndCountriesList = countryLanguageService.getLanguageAndCountriesDtoList();
        model.addAttribute("languages", languageAndCountriesList);
